    ...
    <div style={{ padding: '8px 16px 48px', maxWidth: 1200, margin: '0 auto', fontFamily: FONT, position: 'relative' }}>
      ...
      <div style={{ ...hard(), background: '#ffffff', padding: 18 }}>
        ...
        <input
          ...
          style={{ width: '100%', border: `1px solid #e8e8e8`, borderRadius: 2, padding: '10px 12px', fontFamily: FONT, fontSize: 15, outline: 'none', marginBottom: 18 }}
        />
        ...
        <div style={{ display: 'flex', gap: 12, marginBottom: 18 }}>
          ...
          <div style={{ flex: 1 }}>
            <select
              ...
              style={{ width: '100%', border: `1px solid #e8e8e8`, borderRadius: 2, padding: '10px 12px', fontFamily: FONT, fontSize: 15, outline: 'none', background: '#ffffff', color: INK }}
            >
        ...
        <textarea
          ...
          style={{ width: '100%', height: 96, border: `1px solid #e8e8e8`, borderRadius: 2, padding: '10px 12px', fontFamily: FONT, fontSize: 15, outline: 'none', resize: 'none', marginBottom: 18 }}
        />
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 20 }}>
          {images.map((src, i) => (
            <div key={i} style={{ position: 'relative', width: 64, height: 64, border: `1px solid #e8e8e8`, borderRadius: 2, overflow: 'hidden', background: '#efefef' }}>
