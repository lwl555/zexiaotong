  ...
  return (
    <div style={{ padding: '8px 16px 48px', maxWidth: 1200, margin: '0 auto', fontFamily: FONT, position: 'relative' }}>
      ...
      <input
        ...
        style={{ width: '100%', border: `1px solid #e8e8e8`, borderRadius: 2, padding: '11px 12px', fontFamily: FONT, fontSize: 15, outline: 'none', marginBottom: 18, boxSizing: 'border-box' }}
      />
      ...
      <textarea
        ...
        style={{ width: '100%', height: 160, resize: 'none', border: `1px solid #e8e8e8`, borderRadius: 2, padding: '11px 12px', fontFamily: FONT, fontSize: 15, outline: 'none', marginBottom: 18, boxSizing: 'border-box' }}
      />

      <SectionLabel label="配图（最多 9 张）" />
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, marginBottom: 24 }}>
        {images.map((src, i) => (
          <div key={i} style={{ position: 'relative', width: 84, height: 84, border: `1px solid #e8e8e8`, borderRadius: 2, overflow: 'hidden', background: '#efefef' }}>
